    ...
    return (
        <div className="container mt-3">
            <Figure className="figure d-flex justify-content-center flex-cloumn">
                ...
                <Figure.Caption className="figure-caption align-bottom ms-2"> <p className="text-left">Bienvenido al Gestor de Reservas! Accede como usuario
                    o como gimnasio para crear tus clases o reservarlas!</p></Figure.Caption>
            </Figure>
